...
class AgendaService {
 public:
  ...
  /**
  * reset user's infomation
  * @return if success, true will be returned
  */
  bool resetInfo(const std::string &userName, 
				 const std::string &email, 
				 const std::string &phone);
  

  /**
  * reset user's password by confirming current password
  * @param old_password current password
  * @param new_password new password
  * @return if success, true will be returned
  */
  int resetPsd(const std::string &userName,
